...
def prepare_database():
    """Setup Database"""
    sql_create_pull_requests_table = """ CREATE TABLE IF NOT EXISTS pull_requests ( id          INTEGER     PRIMARY KEY AUTOINCREMENT, title       TEXT        NOT NULL, created_at  TEXT        NOT NULL, updated_at  TEXT        NOT NULL, approved    INTEGER     DEFAULT 0 ); """
